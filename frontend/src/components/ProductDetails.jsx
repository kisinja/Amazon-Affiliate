            ...
            <div className="max-w-6xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="p-8">
                        ...
                        <div className="flex items-center mt-6">
                            ...
                            {product.featured && (
                                <span className="ml-4 text-sm px-2 py-1 bg-orange-500 text-white rounded-md">
                                    Featured
                                </span>
                            )}
                        </div>
                        ...
                        <div className="flex gap-6 mt-8">
                            ...
                            <div className="">
                                <a
                                    ...
                                    className="inline-block w-full md:w-auto bg-primary text-white font-medium text-lg px-3 py-1 rounded-md hover:bg-primary/80 transition duration-300"
                                >
                                    Buy Now
                                </a>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                >
                                    <FaHeart className="mr-2 text-xl" /> Save for Later
                                </button>
                            </div>
                        </div>
                ...
                <div className="p-8 border-t mt-6">
                    ...
                    <p className="text-gray-600">
                        Transform your walls into a gallery-worthy space with
                        our Elegant Wall Art Set. Designed for art enthusiasts,
                        it complements any modern or traditional decor.
                    </p>
                </div>
            </div>
        </div>
